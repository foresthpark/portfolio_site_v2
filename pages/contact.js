...
const contact = () => {
  return (
    <div className="w-full min-h-screen bg-red-300 flex flex-col justify-center items-center">
      <Head>
      ...
      <div className="font-sans font-black text-6xl tracking-wide sm:text-15xl text-center">
        CONTACT
      </div>
