...
const about = () => {
  return (
    <div className="w-full h-screen bg-yellow-300 flex flex-col justify-content items-stretch">
      <Head>
        <title>林 :: About</title>
      </Head>
      ...
      <div className="sm:my-5 sm:text-base text-sm mt-3 mx-2 text-center">
        ...
        people. Building a great product is cool, but I also love helping other
        people build incredible stuff.
      </div>
      {/* Skills Section */}
